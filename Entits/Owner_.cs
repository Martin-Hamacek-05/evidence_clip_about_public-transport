...
{
    /// <summary>
    /// Reprezentation entit Owner_ in database
    /// </summary>
    public class Owner_:I_Work_with_Csv
    {
        private int id;
        ...
        public Owner_(int id, string name_, string headquarters, string note)
        {
            if (name_.Length > 100) 
            { 
        ...
        public object from_csv(string row)
        {
            ...
            return new Owner_(Int32.Parse(splited[0]), splited[1], splited[2], splited[3]);
        }
