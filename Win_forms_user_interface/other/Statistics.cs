...
namespace evidence_clip_about_public_transport.Win_forms_user_interface.other
{
    public partial class Statistics : Form
    {
        ...
        private void export_chart_button_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    Chart_switcher.file_chart(Path.GetFullPath(saveFileDialog.FileName), saveFileDialog.FilterIndex, FormsPlot1, Convert.ToInt32(width.Value), Convert.ToInt32(height.Value));
