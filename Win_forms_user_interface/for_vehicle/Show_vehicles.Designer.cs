namespace evidence_clip_about_public_transport.Win_forms_user_interface.for_vehicle
{
    partial class Show_vehicles
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Show_vehicles));
            ...
            toolstrip_for_work_with_table.Items.AddRange(new ToolStripItem[] { new_record, toolStripSeparator1, load_button, toolStripSeparator2, search_with_clip_name_label, search_clip_textbox, search_button, toolStripSeparator3, header });
            ...
            search_with_clip_name_label.Size = new Size(180, 22);
            search_with_clip_name_label.Text = "Vyhledat podle evidenčního čísla";
            // 
            // search_clip_textbox
            // 
            ...
            Name = "Show_vehicles";
            Text = "Evidence záběrů - správa vozidel";
