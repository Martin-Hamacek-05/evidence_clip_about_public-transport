...
{
    public partial class Edit_subtype : Form, I_Edit_data_in_table
    {
        public Edit_subtype()
        {
            InitializeComponent();
        ...
        private void create_button_Click(object sender, EventArgs e)
        {
            ...
            if (subtype.Checked)
            {
                MessageBox.Show(create.update_subtype_mean_of_transport_with_predecessor(new Subtype_mean_of_transport(0, name_.Text, Convert.ToInt32(subtype_combobox.SelectedValue))));
            }
            else
            {
        ...
        private void update_button_Click(object sender, EventArgs e)
        {
            ...
            if (subtype.Checked)
            {
                MessageBox.Show(edit.update_subtype_mean_of_transport_with_predecessor(new Subtype_mean_of_transport(Int32.Parse(id_label.Text), name_.Text, Convert.ToInt32(subtype_combobox.SelectedValue))));
            }
            else
            {
