...
{
    public partial class Show_subtype_mean_of_transport : Form,I_List_from_table
    {
        private readonly string[] headers_in_czech = { "název podtypu", "podtyp" };
        public Show_subtype_mean_of_transport()
        {
            InitializeComponent();
        ...
        {
            Edit_subtype_mean_of_transport edit_Subtype_Mean_Of_Transport = new Edit_subtype_mean_of_transport();
        ...
        private void data_from_select_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Edit_subtype_mean_of_transport edit = new Edit_subtype_mean_of_transport();
