namespace evidence_clip_about_public_transport.Win_forms_user_interface.for_stops
{
    partial class Show_stops
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Show_stops));
            ...
            mass_renaming = new ToolStripButton();
            ...
            menu_trip_on_top.Size = new Size(788, 24);
            ...
            toolstrip_for_work_with_table.Items.AddRange(new ToolStripItem[] { new_record, toolStripSeparator1, load_button, toolStripSeparator2, search_with_label, search_textbox, search_button, toolStripSeparator3, mass_renaming, toolStripSeparator4, header });
            toolstrip_for_work_with_table.Location = new Point(0, 24);
            toolstrip_for_work_with_table.Name = "toolstrip_for_work_with_table";
            toolstrip_for_work_with_table.Size = new Size(788, 25);
            ...
            // mass_renaming
            // 
            mass_renaming.DisplayStyle = ToolStripItemDisplayStyle.Text;
            mass_renaming.Image = (Image)resources.GetObject("mass_renaming.Image");
            mass_renaming.ImageTransparentColor = Color.Magenta;
            mass_renaming.Name = "mass_renaming";
            mass_renaming.Size = new Size(144, 22);
            mass_renaming.Text = "Hromadné přejmenování";
            mass_renaming.Click += mass_renaming_Click;
            // 
            // toolStripSeparator4
            // 
            ...
            status_strip.Size = new Size(788, 22);
            ...
            data_from_select.Size = new Size(788, 199);
            ...
            Name = "Show_stops";
            Text = "Evidence záběrů - výpis zastávek";
        ...
        private ToolStripButton mass_renaming;
