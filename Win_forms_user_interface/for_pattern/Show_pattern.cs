...
{
    public partial class Show_pattern : Form,I_List_from_table
    {
        private readonly string[] headers_in_czech = { "název náťeru", "poznámky" };
        public Show_pattern()
        {
            InitializeComponent();
        ...
        {
            Edit_pattern new_Pattern = new Edit_pattern();
            new_Pattern.Show();
        }
        private void load_button_Click(object sender, EventArgs e)
        {
            I_DAO_Pattern producers = Database_server_switch.dAO_pattern();
            data_from_select.DataSource = producers.get_all_patterns().Tables[0];
        ...
        {
            I_DAO_Pattern load = Database_server_switch.dAO_pattern();
            Edit_pattern edit = new Edit_pattern();
            ...
            if (selected != -1)
            {
                ...
                edit.set_pattern(load.get_pattern(Convert.ToInt32(selected_row.Cells[0].Value)));
                edit.Show();
            }
        }
        ...
        private void search_button_Click(object sender, EventArgs e)
        {
            try
            {
                data_from_select.Columns[1].HeaderText = "name_of_pattern";
