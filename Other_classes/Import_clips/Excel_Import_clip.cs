...
{
    /// <summary>
    /// import data of clip from xlsx file in simplified format to DataTable
    /// </summary>
    public class Excel_Import_clip : I_Import_clip
    {
        ...
        /// <summary>
        /// separator of datatypes
        /// </summary>
        /// <param name="c"></param>
        /// <param name="shh"></param>
        /// <param name="index"></param>
        /// <param name="clip"></param>
        private static void sete(Cell c, SharedStringTable shh, int index, object[] clip)
        {
            switch (index)
            {
                case 0:
                ...
                case 7:
                    ...
                    if ((c.DataType != null) && (c.DataType == CellValues.SharedString))
                        clip[7] = shh.ChildElements[int.Parse(c.CellValue.Text)].InnerText.ToString();
                    break;
